...
# parameters that might be adjusted in simulation
existing_data = None  # constants.USE_EXISTING_DATA_PYTHON
is_print_summary, save_to_pickle = True, True
UE_power = 100  # UE UL power (mW)
area = 8  # area size in km2
...
top_N_CPUs = 2  # each UE can be served by top_N_CPUs CPUs maximum
...
# LLSFB
max_UEs_per_AP = math.inf
_ = LLSFB.allocate_UEs_to_CPUs(gain_over_noise_dB, R, H, Np, AP_CPU_association, tau_p, tau_c, p_UEs,
